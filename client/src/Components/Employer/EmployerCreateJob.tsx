...
import { Dismiss12Regular, ChevronRight20Regular, CheckmarkCircle20Regular } from "@fluentui/react-icons";
...
const useStyles = makeStyles({
  root: { minHeight: "100%", padding: "16px 0 32px", display: "flex", flexDirection: "column", alignItems: "center", backgroundColor: "#FFF5F5" },
  content: { width: "100%", maxWidth: "960px", display: "flex", flexDirection: "column", rowGap: "16px" },
  stepsCard: {
  ...
  stepsHeaderRow: { display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "4px" },
  ...
  stepsRow: { display: "grid", gridTemplateColumns: "repeat(4, minmax(0, 1fr))", columnGap: "16px", marginTop: "8px", "@media (max-width: 640px)": { gridTemplateColumns: "repeat(2, minmax(0, 1fr))", rowGap: "10px" } },
  stepItem: { display: "flex", alignItems: "flex-start", columnGap: "10px", fontSize: "0.8rem" },
  stepCircleBase: { width: "30px", height: "30px", borderRadius: "999px", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "0.85rem", fontWeight: 600, flexShrink: 0 },
  stepCircleActive: { backgroundColor: "#0118D8", color: "#FFFFFF" },
  stepCircleCompleted: { backgroundColor: "#0118D8", color: "#FFFFFF" },
  stepCirclePending: { ...shorthands.border("2px", "solid", "rgba(2,6,23,0.08)"), color: "#5B6475" },
  stepLabelTitle: { color: "#0B1220", fontWeight: 500, fontSize: "0.85rem", marginBottom: "2px" },
  ...
  sectionTitle: { fontSize: "0.98rem", fontWeight: 600, color: "#0B1220", marginBottom: "4px" },
  sectionSubtitle: { fontSize: "0.8rem", color: "#6B7280" },
  formGridTwo: { display: "grid", gridTemplateColumns: "repeat(2, minmax(0, 1fr))", columnGap: "16px", "@media (max-width: 768px)": { gridTemplateColumns: "minmax(0, 1fr)", rowGap: "10px" } },
  formRow: { display: "flex", flexDirection: "column", rowGap: "4px", marginBottom: "12px" },
  ...
  skillsChipsRow: { display: "flex", flexWrap: "wrap", gap: "6px", marginTop: "8px" },
  skillBadge: { backgroundColor: "#E9DFC3", color: "#0B1220", ...shorthands.border("1px", "solid", "#E9DFC3"), paddingInline: "10px", paddingBlock: "6px", display: "inline-flex", alignItems: "center", columnGap: "6px" },
  reviewBox: { marginTop: "8px", padding: "12px 14px", backgroundColor: "#FFF8F8", ...shorthands.borderRadius("12px"), ...shorthands.border("1px", "solid", "rgba(2,6,23,0.08)"), display: "flex", flexDirection: "column", rowGap: "10px" },
  reviewLabel: { fontSize: "0.75rem", color: "#5B6475", marginBottom: "2px" },
  reviewValue: { color: "#0B1220", fontWeight: 500 },
  actionsBar: { marginTop: "16px", display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", rowGap: "8px" },
...
function parseSalaryRange(input: string): { start?: number; end?: number } {
  ...
  const parts = cleaned.split(/-|to/).map((x) => x.trim()).filter(Boolean);
        ...
        <Card className={styles.stepsCard}>
          <div className={styles.stepsHeaderRow}>
            <div className={styles.stepsTitleBlock}>
              ...
              <span className={styles.stepsSubtitle}>Step {currentStep} of {steps.length}</span>
            </div>
                ...
                <div key={step.id} className={styles.stepItem}>
                  <div
                    className={`${styles.stepCircleBase} ${
                      isCompleted ? styles.stepCircleCompleted : isActive ? styles.stepCircleActive : styles.stepCirclePending
                    }`}
                  >
          ...
          {currentStep === 1 && (
            <div>
              <div className={styles.sectionHeader}>
                ...
                <div className={styles.sectionSubtitle}>Enter the basic information about the job opening.</div>
              </div>
              ...
              <div className={styles.formRow}>
                ...
                <Input placeholder="e.g. Senior Frontend Developer" value={title} onChange={(_, d) => setTitle(d.value)} />
              </div>
              ...
              <div className={styles.formGridTwo}>
                <div className={styles.formRow}>
                  ...
                  <Dropdown value={jobType} onOptionSelect={(_, d) => setJobType((d.optionValue ?? "full-time") as typeof jobType)}>
                ...
                <div className={styles.formRow}>
                  ...
                  <Input placeholder="e.g. hybrid / remote / on-site" value={location} onChange={(_, d) => setLocation(d.value)} />
                </div>
              </div>
              ...
              <div className={styles.formGridTwo}>
                <div className={styles.formRow}>
                  ...
                  <Dropdown value={workType} onOptionSelect={(_, d) => setWorkType((d.optionValue ?? "remote") as typeof workType)}>
                ...
                <div className={styles.formRow}>
                  ...
                  <Input placeholder="e.g. 1" value={workExperienceText} onChange={(_, d) => setWorkExperienceText(d.value)} />
                </div>
              </div>
              ...
              <div className={styles.formGridTwo}>
                <div className={styles.formRow}>
                  ...
                  <Input placeholder="e.g. 12 - 15" value={salaryRangeText} onChange={(_, d) => setSalaryRangeText(d.value)} />
                </div>
              ...
              <div className={styles.formRow}>
                ...
                <Textarea placeholder="Describe the role..." rows={6} value={description} onChange={(_, d) => setDescription(d.value)} />
              </div>
            </div>
          )}
          ...
          {currentStep === 2 && (
            <div>
              <div className={styles.sectionHeader}>
                ...
                <div className={styles.sectionSubtitle}>Specify the skills and technologies required for this role.</div>
              </div>
                  ...
                  {selectedSkills.map((skill) => (
                    <Badge key={skill} appearance="filled" className={styles.skillBadge}>
                      ...
                      <button
                        ...
                        style={{ border: "none", background: "transparent", padding: 0, display: "flex", alignItems: "center", cursor: "pointer" }}
                      >
                        <Dismiss12Regular />
                      </button>
                    </Badge>
            ...
            <div>
              ...
              <div className={styles.formGridTwo}>
                <div className={styles.formRow}>
                  ...
                  <Dropdown value={difficultyLevel} onOptionSelect={(_, d) => setDifficultyLevel((d.optionValue ?? "easy") as typeof difficultyLevel)}>
          ...
          {currentStep === 4 && (
            <div>
              <div className={styles.sectionHeader}>
                ...
                <div className={styles.sectionSubtitle}>Review all the details before publishing the job post.</div>
              </div>
              ...
              <div className={styles.reviewBox}>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "repeat(3, minmax(0, 1fr))", columnGap: "12px", rowGap: "8px" }}>
                  <div>
                ...
                <div>
                  ...
                  <div style={{ color: "#111827", fontSize: 13, whiteSpace: "pre-wrap" }}>{description || "—"}</div>
                </div>
              </div>
            </div>
          )}
